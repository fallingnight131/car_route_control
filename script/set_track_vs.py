...
track_inner = [
    (150, 650), (250, 600), (300, 550), (380, 530), (400, 500),
...
save_track_data("src/config/track_info/vs.json", track_outer, track_inner, check_line)
print("Track data saved to src/config/track_info/vs.json")
